...
# Soporte para filtrar por lista de IDs en formato CSV (ej: ?ids=1,2,3)
class NumberInFilter(filters.BaseInFilter, filters.NumberFilter):
    pass

# Definir el filtro 'ids' dentro del FilterSet para no listar un campo no-model en Meta.fields
ProductFilter.ids = NumberInFilter(field_name='id', lookup_expr='in')
